...
pki.publicKeyFromAsn1 = function(obj) {
  ...
  var oid
  try {
    oid = asn1.derToOid(obj.value[0].value[0].value);
  } catch {
    // Fallback
    oid = asn1.derToOid(obj.value[0].value[6].value[0].value[0].value);
  }
  switch (oid) {
  ...
  case pki.oids.ecPublicKey:
    try {
      ...
      return ecdsa.ECPublicKey.fromAsn1(obj.value[0].value[6]);
    }
  default:
