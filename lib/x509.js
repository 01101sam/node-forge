...
pki.createCertificate = function() {
  ...
  cert.sign = function(key, md) {
    ...
    var algorithmOid = oids[key instanceof ECPrivateKey ? 'ecdsaWith' +  cert.md.algorithm.toUpperCase() : cert.md.algorithm + 'WithRSAEncryption'];
    if(!algorithmOid) {
...
function _fillMissingFields(attrs) {
  ...
  for(var i = 0; i < attrs.length; ++i) {
    ...
    if (attr.name === "title") {
      attr.value = asn1.create(asn1.Class.UNIVERSAL, asn1.Type.UTF8, true, attr.value.value);
    }
  }
}
...
function _fillMissingExtensionFields(e, options) {
  ...
  // value is UTF8 STRING
  if (e.name === "title") {
    e.value = asn1.create(asn1.Class.UNIVERSAL, asn1.Type.UTF8, true, "TEE");
  }
...
pki.getTBSCertificate = function(cert) {
  ...
  var tbs = asn1.create(asn1.Class.UNIVERSAL, asn1.Type.SEQUENCE, true, [
    ...
    // SubjectPublicKeyInfo
    cert.publicKey instanceof ECPublicKey ? cert.publicKey.toAsn1() : pki.publicKeyToAsn1(cert.publicKey)
  ]);
